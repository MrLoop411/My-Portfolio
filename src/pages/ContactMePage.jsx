...
import { FaInstagram, FaLinkedinIn, FaTwitter, FaGithub, FaEnvelope, FaPhone, FaMapMarkerAlt, FaBars, FaTimes } from "react-icons/fa";
      ...
      <div className="relative z-10">
        ...
        <nav className="flex items-center justify-between px-8 py-6 lg:px-20 relative">
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <Link to="/contactme" className="text-orange-500 hover:text-orange-500 transition-colors">Contact</Link>
          </div>
          ...
          {mobileMenuOpen && (
            <div className="absolute top-full left-0 right-0 bg-gray-900/98 backdrop-blur-sm border-t border-gray-700 md:hidden z-[999] shadow-lg">
              <div className="px-8 py-6 space-y-4">
                ...
                <Link to="/contactme" className="block py-2 text-orange-500 hover:text-orange-500 transition-colors" onClick={() => setMobileMenuOpen(false)}>Contact</Link>
