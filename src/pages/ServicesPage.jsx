...
import { FaCode, FaMobile, FaGlobe, FaPalette, FaRocket, FaUsers, FaServer, FaDatabase, FaCloud, FaLaptopCode, FaBars, FaTimes } from "react-icons/fa";
          ...
          {mobileMenuOpen && (
            <div className="absolute top-full left-0 right-0 bg-gray-900/98 backdrop-blur-sm border-t border-gray-700 md:hidden z-[999] shadow-lg">
              <div className="px-8 py-6 space-y-4">
                ...
                <Link 
                  to="/services" 
                  className="block py-2 text-orange-500 transition-colors"
                  onClick={() => setMobileMenuOpen(false)}
                >
                  Services
                </Link>
